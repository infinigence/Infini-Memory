...
from infini_memory_classic import InfiniMemory, InfiniMemoryConfig  # noqa: E402
...
def test_add():
    ...
    mem.add(test_chunk1, store="test_store", user_id="test_user", cfg=cfg, llm=llm)
    mem.add(test_chunk2, store="test_store", user_id="test_user", cfg=cfg, llm=llm)
